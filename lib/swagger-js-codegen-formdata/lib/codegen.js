...
var getViewForSwagger2 = function(opts, type) {
  ...
  _.forEach(swagger.paths, function(api, path) {
    ...
    _.forEach(api, function(op, m) {
      ...
      // by Cory
      var findExamples = function(responses) {
        var examples = [];
        var responseKeys = Object.keys(responses);
        responseKeys.forEach(k => {
          if (!responses[k].examples) {
            return;
          }
          examples.push(responses[k].examples["application/json"]); // maybe add a test first
        });
        return examples;
      };
      ...
      var method = {
        ...
        methodTags: op.tags, // by cory
        methodGroup: op.tags[0], // by cory
        method: M,
        isGET: M === "GET",
        isPOST: M === "POST",
        ...
        exampleString: JSON.stringify(findExamples(op.responses), null, 2)
        //exampleString: findExamples(op.responses)
      };
      //console.log("codegen.js method", method);
  ...
  swagger.apis.forEach(function(api) {
    api.operations.forEach(function(op) {
      ...
      var method = {
        ...
        tags: op.tags, // by cory
        examples: op.examples, //by cory
        headers: []
      };
